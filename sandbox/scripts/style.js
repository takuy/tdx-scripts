...
jQuery(document).ready(function() {
    ...
    $('head').append('<link rel="stylesheet" type="text/css" href="https://takuy.github.io/tdx-scripts/sandbox/style/genesys.css">');
   // $('head').append('<link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css">');
    ...
    jQuery('body').append('<a onclick="showPopup()" title="Live Chat with the TSC Help Desk" href="#"><div class="floaty-chat"></div></a>');
